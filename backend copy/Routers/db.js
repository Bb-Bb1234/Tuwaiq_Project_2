...
const user = [
    {
        ...
        RecordedTest:[
         ...
         AvailableTest:[
           ...
           {
            TestNaem:"اختبار كفايات اللغة الإنجليزية لمرشحي الجامعة السعودية الإلكترونية – نوفمبر 2021",   
            RecordingStatus:"تسجيل مبكر",
           ...
           {
            TestNaem:"الاختيار الوظيفي - اختبار القدرة المعرفية العامة – رجال – يناير 2022م",   
            RecordingStatus:"تسجيل مبكر",
            Testlanguage:"عربي",
            TestMechanism:"ورقي",
           ...
           {
            TestNaem:"اختبار تحديد مستوى اللغة الإنجليزية - English Placement Test (EPT)",   
            RecordingStatus:"تسجيل متأخر",
            Testlanguage:"انجليزي",
            TestMechanism:"محوسب",
        ...
        CanceledTest:[
            {
                TestNaem:"اختبار المعلمين الجدد – رجال – الاختبار التخصصي - نوفمبر 2019",
    ...
    {id:2,
        ...
        RecordedTest:[
         ...
         AvailableTest:[
           ...
           {
            TestNaem:"الاختيار الوظيفي - اختبار القدرة المعرفية العامة – رجال – ابريل 2018م",   
            RecordingStatus:"تسجيل مبكر",
            Testlanguage:"عربي",
            TestMechanism:"ورقي",
